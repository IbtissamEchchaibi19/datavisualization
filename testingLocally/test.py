...
def generate_invoice_data():
    # Product variations
    products = [
        'Sidr Honey 90g', 'Acacia Honey 90g', 'Wildflower Honey 90g',
        'Mountain Honey 90g', 'Forest Honey 90g', 'Royal Jelly Honey 90g',
        'Manuka Honey 90g', 'Clover Honey 90g'
    ]
...
def generate_invoices_for_dashboard(num_invoices=100):
    ...
    for i in range(num_invoices):
        ...
        pdf_path = os.path.join(output_dir, f"invoice-{i+1}.pdf")
