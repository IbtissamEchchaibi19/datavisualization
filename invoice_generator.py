...
output_dir = os.path.join(current_dir, "invoices")
...
def generate_invoice_data():
    # Product variations
    products = [
        'Sidr Honey 900g', 'Acacia Honey 900g', 'Wildflower Honey 900g',
        'Mountain Honey 900g', 'Forest Honey 900g', 'Royal Jelly Honey 900g',
        'Manuka Honey 900g', 'Clover Honey 900g'
    ]
...
def generate_invoices_for_dashboard(num_invoices=100):
    ...
    for i in range(num_invoices):
        ...
        pdf_path = os.path.join(output_dir, f"invoice_{i+1}.pdf")
        create_invoice_pdf(data, pdf_path)
        
        # Store data for analysis
        all_invoice_data.append(data)
        
        print(f"Generated invoice_{i+1}.pdf")
...
# Generate invoices
invoice_data = generate_invoices_for_dashboard(200)